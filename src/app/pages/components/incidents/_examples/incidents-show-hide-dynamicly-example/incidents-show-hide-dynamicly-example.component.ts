...
import { IncidentsStore } from '../../../../../store';
      ...
      incidents: [
        {
          id: 1,
          title:
            'The Object Storage service in location hel1 is currently degraded. Requests to download or upload objects may fail or time out. We are already working on fixing the issue and getting things back to normal.',
        },
        {
          id: 2,
