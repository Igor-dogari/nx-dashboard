...
import { DataViewComponent } from '@core/components';
import { HttpClient } from '@angular/common/http';
import { MatRadioButton, MatRadioGroup } from '@angular/material/radio';
import { FormsModule } from '@angular/forms';
import { DataViewCellRenderer, DataViewColumnDef } from '@core/models';
...
export class DataViewCustomCellRenderersExampleComponent implements OnInit {
  ...
  cellRenderers: DataViewCellRenderer[] = [
    {
      dataRenderer: 'user',
      component: () => import('../../_prebuilt-renderers/user-cell/user-cell-renderer.component').then(c => c.UserCellRendererComponent)
    },
    {
      dataRenderer: 'date',
