...
import { NotificationControlsDefDirective, NotificationDefDirective } from '@core/directives';
...
export class NotificationListComponent<T extends NotificationInterface> implements AfterContentInit {
