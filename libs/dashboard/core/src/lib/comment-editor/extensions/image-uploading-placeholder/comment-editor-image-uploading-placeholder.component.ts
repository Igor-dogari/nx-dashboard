...
@Component({
  ...
  templateUrl: './comment-editor-image-uploading-placeholder.component.html',
  styleUrl: './comment-editor-image-uploading-placeholder.component.scss',
  host: {
    'class': 'emr-image-uploading-placeholder',
    '[class.selected]': 'selected'
  }
})
export class CommentEditorImageUploadingPlaceholderComponent extends AngularNodeViewComponent implements OnInit, OnDestroy {
