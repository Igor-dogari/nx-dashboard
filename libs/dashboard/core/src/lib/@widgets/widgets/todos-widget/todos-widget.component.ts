...
import { DASHBOARD, DashboardInterface, WidgetInterface, WidgetComponentInterface } from '@core';
...
export class TodosWidgetComponent implements WidgetComponentInterface {
