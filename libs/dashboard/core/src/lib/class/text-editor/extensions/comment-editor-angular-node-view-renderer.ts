...
import { AngularNodeViewComponent } from '@core/components';
...
class AngularNodeView extends NodeView<Type<AngularNodeViewComponent>, Editor, AngularNodeViewRendererOptions> {
  renderer!: CommentEditorAngularRenderer<AngularNodeViewComponent, NodeViewProps>;
...
export const CommentEditorAngularNodeViewRenderer = (
