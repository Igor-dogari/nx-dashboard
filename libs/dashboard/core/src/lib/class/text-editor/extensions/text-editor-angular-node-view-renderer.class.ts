...
import { TextEditorAngularNodeViewComponent } from '@core/components';
import { CommentEditorAngularRenderer } from './comment-editor-angular-renderer';
...
class AngularNodeView extends NodeView<Type<TextEditorAngularNodeViewComponent>, Editor, AngularNodeViewRendererOptions> {
  renderer!: CommentEditorAngularRenderer<TextEditorAngularNodeViewComponent, NodeViewProps>;
  ...
  override mount() {
    ...
    // create renderer
    this.renderer = new CommentEditorAngularRenderer(this.component, injector, props);
...
export const TextEditorAngularNodeViewRenderer = (
  ViewComponent: Type<TextEditorAngularNodeViewComponent>,
